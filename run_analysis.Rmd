...
This step used the aggregate() function to group by subject and activity and calculate the mean on the measurement variables. The results are stored in the tidyHarData dataset, and are written to the local directory as "Summary_HAR_Statistics.csv".
